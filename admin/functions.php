...
function url_get_contents($url, $proxy = null)
{
    ...
    curl_setopt($ch, CURLOPT_USERAGENT, 'Video Downloader');
...
{
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, "https://www.youtube.com/watch?v=hoNb6HuNmU0");
    curl_setopt($ch, CURLOPT_HEADER, 0);
    ...
    $result = curl_exec($ch);
    preg_match_all('/hoNb6HuNmU0/', $result, $output);
    curl_close($ch);
