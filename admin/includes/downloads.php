                            ...
                            if (!empty($downloads_list)) {
                                foreach ($downloads_list as $download) {
                                    ...
                                    if (filter_var($meta["thumbnail"] ?? null, FILTER_VALIDATE_URL)) {
                                        ...
                                        echo "<td><img src='" . $meta["thumbnail"] . "' class='img img-thumbnail rounded h-25' onerror=\"this.src='https://dummyimage.com/600x400/b0a7b0/000000.jpg&text=NO+THUMBNAIL';\"></td>";
