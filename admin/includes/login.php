...
<head>
    ...
    <link href="/admin/assets/css/ui.css" rel="stylesheet"/>
</head>
...
<div class="wrapper wrapper-full-page ">
    <div class="full-page login-page section-image" filter-color="blue">
        ...
        <div class="full-page-background" style="background-image: url(/admin/assets/img/bg19.jpg) "></div>
        <footer class="footer">
            <div class="container-fluid">
...
<script src="/admin/assets/js/dashboard.js" type="text/javascript"></script>
</body>